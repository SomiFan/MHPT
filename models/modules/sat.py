...
class SATBlock(nn.Module):
    """
    Self Attention transformer block with shifted window scheme and cross-modal skip connection
    """
    ...
    def forward(self, ms, pan):
        ...
        # W-MSA/SW-MSA
        attn_ms_windows = self.attn_ms(ms_windows)  # nW*B, window_size*window_size, C
        if self.cm_sc:
